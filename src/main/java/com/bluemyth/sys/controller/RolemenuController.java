...
import com.bluemyth.sys.entity.Rolemenu;
import com.bluemyth.sys.service.RolemenuService;
...
public class RolemenuController extends SuperController {
    ...
    @PutMapping
    public RestStatus update(Rolemenu entity) {
