...
import com.bluemyth.community.entity.Collect;
import com.bluemyth.community.service.CollectService;
...
@Api(tags = {"Collect接口"})
@RestController
@RequestMapping("/community/collect")
public class CollectController extends SuperController {
    ...
    @PutMapping
    public RestStatus update(Collect entity) {
